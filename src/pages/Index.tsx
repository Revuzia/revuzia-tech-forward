        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-1/2 -left-20 transform -translate-y-1/2 animate-fly-across">
            <div className="relative flex items-center">
              <Rocket className="w-20 h-12 text-brand fill-brand opacity-70" style={{ transform: 'scaleX(1.5)' }} />
              <span className="absolute inset-0 flex items-center justify-center text-white font-bold text-xs tracking-wider">
                REVUZIA
              </span>
            </div>
          </div>
