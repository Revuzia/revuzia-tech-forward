...
const DisplayTech = () => {
  const { data: articles, isLoading } = useArticles("get-electrified", "display-tech");

  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Display Tech - Get Electrified | REVUZIA</title>
        <meta name="description" content="Latest innovations in display technology, from MicroLED to flexible screens and next-generation visual experiences." />
      </Helmet>
      <Header />
            ...
            {isLoading ? (
              ...
              <div className="col-span-full text-center py-12">
                ...
                <p className="text-foreground/80 mb-6">
                  We're working on bringing you the latest display technology innovations and insights.
                </p>
                <Link 
                  to="/get-electrified" 
