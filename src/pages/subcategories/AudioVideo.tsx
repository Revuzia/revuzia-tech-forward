...
const AudioVideo = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Audio & Video - Product Reviews | REVUZIA</title>
        <meta name="description" content="In-depth reviews of audio and video equipment including headphones, speakers, sound systems, and entertainment devices." />
      </Helmet>
      <Header />
      ...
      <main className="container mx-auto px-4 py-16">
        <section className="mb-16">
          ...
          <p className="text-xl text-foreground/80 text-center mb-12 max-w-3xl mx-auto">
            Comprehensive reviews of the latest audio and video equipment for every budget and use case.
          </p>
            ...
            {isLoading ? (
              ...
              <div className="col-span-full text-center py-12">
                ...
                <p className="text-foreground/80 mb-6">
                  We're working on bringing you comprehensive audio and video equipment reviews.
                </p>
                <Link 
                  to="/product-reviews" 
