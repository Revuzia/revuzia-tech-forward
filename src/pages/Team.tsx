          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {teamMembers.map((member, index) => (
              <Link key={index} to={`/author/${member.slug}`} className="block group" onClick={() => window.scrollTo(0, 0)}>
                <div className="bg-gradient-card rounded-lg border border-border p-6 hover:border-brand/50 transition-all duration-300 group-hover:scale-105 h-[580px] flex flex-col">
