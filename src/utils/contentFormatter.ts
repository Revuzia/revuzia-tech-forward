export const formatArticleContent = (content: string): string => {
  return content
    ...
    // Make images smaller (40% width instead of 100%)
    .replace(/style="width:100%"/g, 'style="width:40%; margin: 1.5rem auto; display: block;"')
    .replace(/style="width:60%"/g, 'style="width:40%; margin: 1.5rem auto; display: block;"')
